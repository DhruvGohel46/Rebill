        ...
        "standard_reports": [
            {
                ...
                "description": "Detailed breakdown of items sold, group & category summaries, and profits for a specific date.",
                "sheets": ["Summary (with Group & Category)", "Item-Wise Breakdown", "Bill Log"],
            },
            {
                "id": "weekly_sales",
                "name": "Weekly Sales Summary",
                "endpoint": "/api/reports/excel/weekly",
                "description": "Aggregated group, category, and product overview from Monday to Sunday.",
                "sheets": ["Week Overview", "Group & Category Breakdown", "Product Performance"],
            },
            {
                "id": "monthly_sales",
            ...
            },
            {
                ...
                "description": "Combined Sales & Expense yearly audit with group & category sales breakdown, payroll, and transaction ledger.",
                "sheets": [
                    "Executive Summary",
                    "Sales Detail (Year)",
                    "Sales by Group & Category",
                    "Expense Detail (Year)",
                    "Payroll Summary",
                    "Transaction Log",
                ],
